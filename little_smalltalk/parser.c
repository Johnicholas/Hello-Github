...
#include <string.h> // For streq - Johnicholas adds
static void parsePrimitive(); // forward declaration - Johnicholas adds
static void genMessage(); // forward declaration - Johnicholas adds
static void expression(); // forward declaration - Johnicholas adds
static void assignment(); // forward declaration - Johnicholas adds
static void body(); // forward declaration - Johnicholas adds
static void block(); // forward declaration - Johnicholas adds
...
static void genMessage(toSuper, argumentCount, messagesym)
boolean toSuper;
int argumentCount;
object messagesym;
{	boolean sent = false;
