...
#include <stdlib.h> // for exit - Johnicholas adds
static void goDoIt(char*); // forward declarations - Johnicholas adds
static void makeInitialImage(); // forward declarations - Johnicholas adds
