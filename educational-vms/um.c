// from technical report CMU-CS-06-163: "The Cult of the Bound Variable: The 9th Annual ICFP Programming Contest"
// (by Tom Murphy VII, Daniel Spoonhower, Chris Casinghino, Daniel R. Licata, Karl Crary, Robert Harper)
